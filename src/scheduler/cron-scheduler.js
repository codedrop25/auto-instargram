...
class CronScheduler {
  ...
  start() {
    // 매주 화요일 12시~18시, 매주 금요일 17시~18시
    cron.schedule('0 12-18 * * 2', () => this.runUploadJob('화요일'), { timezone: 'Asia/Seoul' });
    cron.schedule('0 17-18 * * 5', () => this.runUploadJob('금요일'), { timezone: 'Asia/Seoul' });
